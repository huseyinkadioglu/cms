<script>
    ...
    var LIBS = {
        ...
        DataTable: [
            "<?php echo base_url("assets"); ?>panel/assets/libs/misc/datatables/datatables.min.css",
            "<?php echo base_url("assets"); ?>panel/assets/libs/misc/datatables/datatables.min.js"
        ],
        fullCalendar: [
            "<?php echo base_url("assets"); ?>/libs/bower/moment/moment.js",
